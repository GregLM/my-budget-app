          ...
          <div className="p-6 flex-1 overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <input type="text" {...register('description', { required: true })} placeholder="Libellé" className="bg-muted p-5 rounded-2xl font-bold text-sm outline-none" />
              ...
              <div className="pt-4 pb-12">
                ...
                {initialData?.id && (
                  <button type="button" onClick={() => onDelete(initialData.id)} className="w-full mt-3 p-3 text-red-500 font-bold text-xs uppercase opacity-50">Supprimer</button>
                )}
              </div>
            </form>
          </div>
